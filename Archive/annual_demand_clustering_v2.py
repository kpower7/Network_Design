...
dbscan = DBSCAN(eps=0.3, min_samples=3)  # Adjusted parameters for more clusters
...
# Save the plot
plt.savefig('annual_demand_clusters_v2.png')
...
annual_demand['Annual_Demand_Pallets'] = annual_demand['Demand_Pallets']
annual_demand = annual_demand.sort_values('Annual_Demand_Pallets', ascending=False)
annual_demand.to_csv('annual_demand_clusters_v2.csv', index=False)
